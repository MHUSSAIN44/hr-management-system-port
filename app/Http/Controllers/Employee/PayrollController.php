<?php
// php artisan make:controller Employee/PayrollController
...
class PayrollController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Get filter options from employee's payroll records
        ...
        // Statistics for current employee
        ...
        return inertia('Employee/Payroll/Index', [
            'payrolls' => $payrolls,
            'employee' => $employee,
            'years' => $years,
            'months' => $months,
    ...
    public function show(Payroll $payroll)
    {
        ...
        // Ensure the payroll belongs to the authenticated employee
        ...
        return inertia('Employee/Payroll/Show', [
            'payroll' => $payroll,
        ]);
    }
    ...
    public function payslip(Payroll $payroll)
    {
        ...
        return inertia('Employee/Payroll/Payslip', [
            'payroll' => $payroll,
        ]);
    }
}