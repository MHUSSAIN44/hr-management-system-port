<!-- resources/js/Pages/Admin/Payroll/Edit.vue -->
<script setup>
    ...
    const form = useForm({
        ...
        accommodation: props.payroll.accommodation,
        allowances: props.payroll.allowances,
        overtime_amount: props.payroll.overtime_amount,
        deductions: props.payroll.deductions,
        month: props.payroll.month,
        year: props.payroll.year,
    });
    ...
    <AdminLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Payroll</h2>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="flex items-center justify-end space-x-4">
                                ...
                                <PrimaryButton :disabled="form.processing">
                                    ...
                                    <span v-else>Update Payroll</span>
                                </PrimaryButton>
                            </div>
                        </form>
                    </div>
