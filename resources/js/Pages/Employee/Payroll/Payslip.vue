<!-- resources/js/Pages/Employee/Payroll/Payslip.vue -->
<script setup>
...
<template>
    <Head :title="`My Payslip - ${getMonthName(payroll?.month)} ${payroll?.year}`" />

    <EmployeeLayout>
        <template #header>
            <div class="flex justify-between items-center print:hidden">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">My Payslip</h2>
                <div class="flex space-x-3">
                    ...
                    <Link :href="route('employee.payroll.show', payroll.id)" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="bg-blue-50 p-6 rounded-lg mb-8">
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <div class="text-center border-l-2 border-blue-300">
                                    ...
                                    <p class="text-2xl font-bold text-blue-600">{{ formatCurrency(payroll?.net_salary || 0) }}</p>
                                </div>
                            </div>
                        </div>
